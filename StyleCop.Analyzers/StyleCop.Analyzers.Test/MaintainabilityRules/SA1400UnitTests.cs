...
namespace StyleCop.Analyzers.Test.MaintainabilityRules
{
    ...
    public class SA1400UnitTests
    {
        ...
        {
            await this.TestTypeDeclarationImplAsync(typeName).ConfigureAwait(true);
        }
        ...
        {
            await this.TestTypeDeclarationImplAsync($"partial {typeName}", warning: false).ConfigureAwait(true);
        }
        ...
        {
            await this.TestTypeDeclarationWithAttributesImplAsync(typeName).ConfigureAwait(true);
        }
        ...
        {
            await this.TestTypeDeclarationWithAttributesImplAsync($"partial {typeName}", warning: false).ConfigureAwait(true);
        }
        ...
        {
            await this.TestTypeDeclarationWithDirectivesImplAsync(typeName).ConfigureAwait(true);
        }
        ...
        {
            await this.TestTypeDeclarationWithDirectivesImplAsync($"partial {typeName}", warning: false).ConfigureAwait(true);
        }
        ...
        {
            await this.TestNestedTypeDeclarationImplAsync(typeName).ConfigureAwait(true);
        }
        ...
        {
            await this.TestNestedTypeDeclarationWithAttributesImplAsync(typeName).ConfigureAwait(true);
        }
        ...
        {
            await this.TestNestedTypeDeclarationWithDirectivesImplAsync(typeName).ConfigureAwait(true);
        }
