...
";
            ...
            await this.VerifyCSharpDiagnosticAsync(testCode, expectedDiagnostic).ConfigureAwait(false);
        }
...
";
            ...
            await this.VerifyCSharpFixAsync(testCode, expected, fixedCode).ConfigureAwait(false);
        }
...
";
            ...
            await this.VerifyCSharpFixAsync(testCode, expectedDiagnostics, fixedCode, expectedFixedDiagnostics).ConfigureAwait(false);
        }
