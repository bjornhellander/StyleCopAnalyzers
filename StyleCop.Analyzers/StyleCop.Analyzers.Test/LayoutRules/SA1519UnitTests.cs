...
namespace StyleCop.Analyzers.Test.LayoutRules
{
    ...
    public class SA1519UnitTests
    {
        ...
        {
            await VerifyCSharpDiagnosticAsync(this.GenerateSingleLineTestStatement(statementText), DiagnosticResult.EmptyDiagnosticResults, CancellationToken.None).ConfigureAwait(true);
        }
        ...
        public async Task TestMultiLineStatementWithoutBracesAsync(string statementText)
        {
            ...
            await VerifyCSharpDiagnosticAsync(this.GenerateMultiLineTestStatement(statementText), expected, CancellationToken.None).ConfigureAwait(true);
        }
...
",
        ...
        {
            await VerifyCSharpDiagnosticAsync(this.GenerateFixedTestStatement(statementText), DiagnosticResult.EmptyDiagnosticResults, CancellationToken.None).ConfigureAwait(true);
        }
...
public class Foo
{
    ...
    unsafe private static void TestMethod()
    {
        ...
        {
            var expected = Diagnostic().WithLocation(7, 13);
            await VerifyCSharpFixAsync(this.GenerateMultiLineTestStatement(statementText), expected, this.GenerateFixedTestStatement(statementText), CancellationToken.None).ConfigureAwait(true);
        }
