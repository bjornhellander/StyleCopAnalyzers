...
";
            ...
            await VerifyCSharpDiagnosticAsync(languageVersion, testCode, DiagnosticResult.EmptyDiagnosticResults).ConfigureAwait(false);
        }
...
";
            ...
            await VerifyCSharpFixAsync(languageVersion, testCode, Diagnostic().WithLocation(8, 14 + typeKeyword.Length), fixedTestCode).ConfigureAwait(false);
        }
    }
}
