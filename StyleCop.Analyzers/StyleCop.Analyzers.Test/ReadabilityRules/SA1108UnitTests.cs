...
public class Foo
{
    public void F()
    {
        ...
        //comment
        {
            ...
            await VerifyCSharpDiagnosticAsync(testCode, new[] { firstDiagnostic, secondDiagnostic }, CancellationToken.None).ConfigureAwait(true);
        }
...
public class Foo
{
    public void F()
    {
        ...
        //bb
        {
            ...
            await VerifyCSharpDiagnosticAsync(testCode, new[] { first, second }, CancellationToken.None).ConfigureAwait(true);
        }
    ...
    public void F()
    {
       try
           ...
           line 2 */
        {
            ...
            await VerifyCSharpDiagnosticAsync(testCode, new[] { first, second, third, fourth }, CancellationToken.None).ConfigureAwait(true);
        }
