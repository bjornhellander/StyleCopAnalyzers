...
";
            await VerifyCSharpDiagnosticAsync(LanguageVersion.CSharp7_2, testCode, DiagnosticResult.EmptyDiagnosticResults).ConfigureAwait(false);
        }
...
";
            ...
            await VerifyCSharpDiagnosticAsync(LanguageVersion.CSharp7_2, testCode, expected).ConfigureAwait(false);
        }
    }
}
